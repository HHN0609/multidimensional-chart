    ...
    <div class="tabCard">
        ...
        <div style="display: flex; height: 100%;">
            ...
            <div class="legendList">
                <div class="color">
                    <div>颜色</div>
                    <select style="width: 120px" v-model="activeChart.color.fieldName">
                        <option value="">Empty</option>
                        <optgroup label="维度">
                            <option v-for="{fieldName} of dimensionNames" :value="fieldName" :key="fieldName">
                                <span>{{ fieldName }}</span>
                            </option>
                        </optgroup>
                        <optgroup label="度量">
                            <option v-for="{fieldName} of measureNames" :value="fieldName" :key="fieldName">
                                <span>{{ fieldName }}</span>
                            </option>
                        </optgroup>
                    </select>
                    ...
                    <select
                        style="width: 120px" 
                        v-model="activeChart.color.aggregateMethod"
                        v-if="activeChart.isAggregation && inputData.fieldAnalyticTypes[activeChart.color.fieldName] === 'measure'"
                    >
                        <option v-for="aggregateMethod of aggregateMethods" :value="aggregateMethod" :key="aggregateMethod">
                ...
                <div class="opacity">
                    <div>透明度</div>
                    <select style="width: 120px" v-model="activeChart.opacity.fieldName">
                        <option value="">Empty</option>
                        <optgroup label="维度">
                            <option v-for="{fieldName} of dimensionNames" :value="fieldName" :key="fieldName">
                                <span>{{ fieldName }}</span>
                ...
                <div class="size">
                    <div>大小</div>
                    <select style="width: 120px" v-model="activeChart.size.fieldName">
                        <option value="">Empty</option>
                        <optgroup label="维度">
                            <option v-for="{fieldName} of dimensionNames" :value="fieldName" :key="fieldName">
                                <span>{{ fieldName }}</span>
                ...
                <div class="shape">
                    <div>形状</div>
                    <select style="width: 120px" v-model="activeChart.shape.fieldName">
                        <option value="">Empty</option>
                        <optgroup label="维度">
                            <option v-for="{fieldName} of dimensionNames" :value="fieldName" :key="fieldName">
                                <span>{{ fieldName }}</span>
...
import dark from "@/assets/themePreview/dark.jpg";
import de from "@/assets/themePreview/default.jpg";
import excel from "@/assets/themePreview/excel.jpg";
import fivethirtyeight from "@/assets/themePreview/fivethirtyeight.jpg";
import ggplot2 from "@/assets/themePreview/ggplot2.jpg";
import googlecharts from "@/assets/themePreview/googlecharts.jpg";
import latimes from "@/assets/themePreview/latimes.jpg";
import powerbi from "@/assets/themePreview/powerbi.jpg";
import quartz from "@/assets/themePreview/quartz.jpg";
import urbaninstitute from "@/assets/themePreview/urbaninstitute.jpg";
import vox from "@/assets/themePreview/vox.jpg";

import useChartData from "@/stores/chartData";
import useInputData from "@/stores/inputData";
import FieldTag from "@/components/sketchpad/fieldTag.vue";
import Draggable from "vuedraggable";
import vegaGrid from "@/components/sketchpad/vegaGrid.vue";
